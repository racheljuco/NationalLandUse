...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h3  class="my-1 float-left"><i class="fas fa-angle-double-right green"></i>&nbsp;{{ !empty($title) ? $title : 'Region' }}</h3>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.region.update', $region->id) }}" id="edit_region_form" name="edit_region_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
