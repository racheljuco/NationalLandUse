...
<div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <a href="{{ route('admin.generallivestockfish_report.index') }}">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                 <a href="{{ route('admin.general_natural_resorce_report.index') }}">
          ...
          <!-- /.col -->
            ...
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                   <a href="{{ route('admin.physical_social_infastructure_report.index') }}">
            ...
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                   <a href="{{ route('admin.general_stakeholders_report.index') }}">
            ...
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                   <a href="{{ route('admin.general_water_resorce_report.index') }}">
