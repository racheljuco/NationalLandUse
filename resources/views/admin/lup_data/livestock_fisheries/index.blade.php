...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">LUP Livestock Data</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <div class="col-12 col-sm-6 col-md-3">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
              <a href="{{ route('admin.livestock_disease.index') }}">
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">LUP Fisheries Data</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <!-- <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="#">Home</a></li>
         ...
         <div class="col-12 col-sm-6 col-md-3">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
              <a href="{{ route('admin.land_use_plan_fish.index') }}">
                <span class="info-box-text">Village Fisheries</span>
                </a>
                <span class="info-box-number">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
              <a href="{{ route('admin.fish_detail.index') }}">
              <span class="info-box-text">Fishering Activities</span>
                </a>
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
              <a href="{{ route('admin.fish_market.index') }}">
