...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h3  class="my-1 float-left"><i class="fas fa-angle-double-right green"></i>&nbsp;{{ trans('farm_inputs.model_plural') }}</h5>
        ...
        @if(count($farmInputs) == 0)
            <div class="card-body text-center">
                <h4>{{ trans('farm_inputs.none_available') }}</h4>
            </div>
        @else
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-sm float-right" role="group">
                                        <a href="{{ route('admin.farm_input.show', $farmInput->id ) }}" class="btn btn-info" title="{{ trans('farm_inputs.show') }}">
