...
<div class="form-group {{ $errors->has('format') ? 'has-error' : '' }}">
    <label for="format" class="col-md-2 control-label">Major Crops</label>
    <div class="col-md-10">
        <div class="radio">
            <label for="format_1">
            	<input id="format_1" class="" name="crop_type_id" type="radio" value="1" checked>
                 Cash
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="crop_type_id" type="radio" value="2">
                 Food
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="crop_type_id" type="radio" value="3">
                 All
            </label>
        </div>
