...
<div class="form-group {{ $errors->has('format') ? 'has-error' : '' }}">
    <label for="format" class="col-md-2 control-label">Major fish Types</label>
    <div class="col-md-10">
        <div class="radio">
            <label for="format_1">
            	<input id="format_1" class="" name="fish_type_id" type="radio" value="1" checked>
                 Kambale
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="fish_type_id" type="radio" value="2">
                 Mbasa
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="fish_type_id" type="radio" value="3">
                 Kolekole
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="fish_type_id" type="radio" value="4">
                 Perege
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="fish_type_id" type="radio" value="5">
                 Vitui
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="fish_type_id" type="radio" value="6">
                 All
            </label>
        </div>
