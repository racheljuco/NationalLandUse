...
<div class="form-group {{ $errors->has('format') ? 'has-error' : '' }}">
    <label for="format" class="col-md-2 control-label">Report Format</label>
    <div class="col-md-10">
        <div class="radio">
            <label for="format_1">
            	<input id="format_1" class="" name="format_id" type="radio" value="1" checked>
                 Excel
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="format_id" type="radio" value="2">
                 PDF
            </label>
        </div>
