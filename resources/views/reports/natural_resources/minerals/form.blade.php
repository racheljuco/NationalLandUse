...
<div class="form-group {{ $errors->has('format') ? 'has-error' : '' }}">
    <label for="format" class="col-md-2 control-label">Major Mineral Types</label>
    <div class="col-md-10">
        <div class="radio">
            <label for="format_1">
            	<input id="format_1" class="" name="mineral_type_id" type="radio" value="1" checked>
                 Aina ya kwanza ya mineral
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="mineral_type_id" type="radio" value="2">
                 Aina ya pili ya mineral
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="mineral_type_id" type="radio" value="3">
                 All
            </label>
        </div>
