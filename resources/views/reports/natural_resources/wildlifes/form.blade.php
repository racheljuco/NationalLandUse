...
<div class="form-group {{ $errors->has('format') ? 'has-error' : '' }}">
    <label for="format" class="col-md-2 control-label">Major Wildlife Types</label>
    <div class="col-md-10">
        <div class="radio">
            <label for="format_1">
            	<input id="format_1" class="" name="wildlife_type_id" type="radio" value="1" checked>
                 Aina ya kwanza ya wildlife
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="wildlife_type_id" type="radio" value="2">
                 Aina ya pili ya wildlife
                 &nbsp;&nbsp;&nbsp;<input id="format_1" class="" name="wildlife_type_id" type="radio" value="3">
                 All
            </label>
        </div>
