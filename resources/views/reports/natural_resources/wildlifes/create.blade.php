...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h3  class="my-1 float-left"><i class="fas fa-pdf green"></i>&nbsp;Wildlife Types</h3>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.wildlife.report.report') }}" accept-charset="UTF-8" id="create_district_form" name="create_district_form" class="form-horizontal">
            {{ csrf_field() }}
            @include ('reports.natural_resources.wildlifes.form', [
                                        'regions' => $regions,
