...
return [
    ...
    'index_route_description' => 'Retrieve existing type investments.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the type investment property name where the value is the assigned value to the retrieved type investment.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved type investment.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of type investments per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved type investment.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new type investment.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing type investment.',
    ...
    'show_route_description' => 'Retrieve existsing type investment.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the type investment to retrieve',
    'destroy_route_description' => 'Delete existsing type investment.',
    ...
    'the_id_of_model_to_delete' => 'The id of the type investment to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete type investments.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the type investment.',
    ...
    'the_requested_model_does_not_exists' => 'The requested type investment does not exists.',
    ...
    'create' => 'Create New Type Investment',
    'delete' => 'Delete Type Investment',
    'edit' => 'Edit Type Investment',
    'show' => 'Show Type Investment',
    'show_all' => 'Show All Type Investment',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Type Investment.',
    'none_available' => 'No Type Investments Available.',
    'model_plural' => 'Type Investments',
    'model_was_added' => 'Type Investment was successfully added.',
    'model_was_retrieved' => 'Type Investment was successfully retrieved.',
    'models_were_retrieved' => 'Type Investments were successfully retrieved.',
    'model_was_updated' => 'Type Investment was successfully updated.',
    'model_was_deleted' => 'Type Investment was successfully deleted.',
    ...
    'model_id_camel_case' => 'type investmentId',
