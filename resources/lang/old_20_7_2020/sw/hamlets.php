...
return [
    ...
    'index_route_description' => 'Retrieve existing hamlets.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the hamlet property name where the value is the assigned value to the retrieved hamlet.',
    ...
    'show_route_description' => 'Retrieve existsing hamlet.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the hamlet to retrieve',
    'destroy_route_description' => 'Delete existsing hamlet.',
    ...
    'the_id_of_model_to_delete' => 'The id of the hamlet to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete hamlets.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the hamlet.',
    ...
    'the_requested_model_does_not_exists' => 'The requested hamlet does not exists.',
    ...
    'create' => 'Create New Hamlet',
    'delete' => 'Delete Hamlet',
    'edit' => 'Edit Hamlet',
    'show' => 'Show Hamlet',
    'show_all' => 'Show All Hamlet',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Hamlet.',
    'none_available' => 'No Hamlets Available.',
    'model_plural' => 'Hamlets',
    'model_was_added' => 'Hamlet was successfully added.',
    'model_was_retrieved' => 'Hamlet was successfully retrieved.',
    'models_were_retrieved' => 'Hamlets were successfully retrieved.',
    'model_was_updated' => 'Hamlet was successfully updated.',
    'model_was_deleted' => 'Hamlet was successfully deleted.',
