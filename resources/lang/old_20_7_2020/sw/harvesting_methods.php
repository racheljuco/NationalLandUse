...
return [
    ...
    'index_route_description' => 'Retrieve existing harvesting methods.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the harvesting method property name where the value is the assigned value to the retrieved harvesting method.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved harvesting method.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of harvesting methods per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved harvesting method.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new harvesting method.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing harvesting method.',
    ...
    'show_route_description' => 'Retrieve existsing harvesting method.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the harvesting method to retrieve',
    'destroy_route_description' => 'Delete existsing harvesting method.',
    ...
    'the_id_of_model_to_delete' => 'The id of the harvesting method to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete harvesting methods.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the harvesting method.',
    ...
    'the_requested_model_does_not_exists' => 'The requested harvesting method does not exists.',
    ...
    'create' => 'Create New Harvesting Method',
    'delete' => 'Delete Harvesting Method',
    'edit' => 'Edit Harvesting Method',
    'show' => 'Show Harvesting Method',
    'show_all' => 'Show All Harvesting Method',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Harvesting Method.',
    'none_available' => 'No Harvesting Methods Available.',
    'model_plural' => 'Harvesting Methods',
    'model_was_added' => 'Harvesting Method was successfully added.',
    'model_was_retrieved' => 'Harvesting Method was successfully retrieved.',
    'models_were_retrieved' => 'Harvesting Methods were successfully retrieved.',
    'model_was_updated' => 'Harvesting Method was successfully updated.',
    'model_was_deleted' => 'Harvesting Method was successfully deleted.',
    ...
    'model_id_camel_case' => 'harvesting methodId',
