...
return [
    ...
    'index_route_description' => 'Retrieve existing agri land statuses.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the agri land status property name where the value is the assigned value to the retrieved agri land status.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved agri land status.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of agri land statuses per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved agri land status.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new agri land status.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing agri land status.',
    ...
    'show_route_description' => 'Retrieve existsing agri land status.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the agri land status to retrieve',
    'destroy_route_description' => 'Delete existsing agri land status.',
    ...
    'the_id_of_model_to_delete' => 'The id of the agri land status to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete agri land statuses.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the agri land status.',
    ...
    'the_requested_model_does_not_exists' => 'The requested agri land status does not exists.',
    ...
    'create' => 'Create New Agri Land Status',
    'delete' => 'Delete Agri Land Status',
    'edit' => 'Edit Agri Land Status',
    'show' => 'Show Agri Land Status',
    'show_all' => 'Show All Agri Land Status',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Agri Land Status.',
    'none_available' => 'No Agri Land Statuses Available.',
    'model_plural' => 'Agri Land Statuses',
    'model_was_added' => 'Agri Land Status was successfully added.',
    'model_was_retrieved' => 'Agri Land Status was successfully retrieved.',
    'models_were_retrieved' => 'Agri Land Statuses were successfully retrieved.',
    'model_was_updated' => 'Agri Land Status was successfully updated.',
    'model_was_deleted' => 'Agri Land Status was successfully deleted.',
    ...
    'model_id_camel_case' => 'agri land statusId',
