...
return [
    ...
    'index_route_description' => 'Retrieve existing agri land scales.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the agri land scale property name where the value is the assigned value to the retrieved agri land scale.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved agri land scale.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of agri land scales per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved agri land scale.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new agri land scale.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing agri land scale.',
    ...
    'show_route_description' => 'Retrieve existsing agri land scale.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the agri land scale to retrieve',
    'destroy_route_description' => 'Delete existsing agri land scale.',
    ...
    'the_id_of_model_to_delete' => 'The id of the agri land scale to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete agri land scales.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the agri land scale.',
    ...
    'the_requested_model_does_not_exists' => 'The requested agri land scale does not exists.',
    ...
    'create' => 'Create New Agri Land Scale',
    'delete' => 'Delete Agri Land Scale',
    'edit' => 'Edit Agri Land Scale',
    'show' => 'Show Agri Land Scale',
    'show_all' => 'Show All Agri Land Scale',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Agri Land Scale.',
    'none_available' => 'No Agri Land Scales Available.',
    'model_plural' => 'Agri Land Scales',
    'model_was_added' => 'Agri Land Scale was successfully added.',
    'model_was_retrieved' => 'Agri Land Scale was successfully retrieved.',
    'models_were_retrieved' => 'Agri Land Scales were successfully retrieved.',
    'model_was_updated' => 'Agri Land Scale was successfully updated.',
    'model_was_deleted' => 'Agri Land Scale was successfully deleted.',
    ...
    'model_id_camel_case' => 'agri land scaleId',
