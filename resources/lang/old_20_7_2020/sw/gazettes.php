...
return [
    ...
    'gn_number' => 'Gn Number',
    'gn_number__placeholder' => 'Enter gn number here...',
    'title' => 'Title',
    'title__placeholder' => 'Enter title here...',
    'published_date' => 'Published Date',
    'published_date__placeholder' => 'Enter published date here...',
    'expired_date' => 'Expired Date',
    'expired_date__placeholder' => 'Enter expired date here...',
    ...
    'index_route_description' => 'Retrieve existing gazettes.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the gazette property name where the value is the assigned value to the retrieved gazette.',
    ...
    'show_route_description' => 'Retrieve existsing gazette.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the gazette to retrieve',
    'destroy_route_description' => 'Delete existsing gazette.',
    ...
    'the_id_of_model_to_delete' => 'The id of the gazette to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete gazettes.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the gazette.',
    ...
    'the_requested_model_does_not_exists' => 'The requested gazette does not exists.',
    ...
    'create' => 'Create New Gazette',
    'delete' => 'Delete Gazette',
    'edit' => 'Edit Gazette',
    'show' => 'Show Gazette',
    'show_all' => 'Show All Gazette',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Gazette.',
    'none_available' => 'No Gazettes Available.',
    'model_plural' => 'Gazettes',
    'model_was_added' => 'Gazette was successfully added.',
    'model_was_retrieved' => 'Gazette was successfully retrieved.',
    'models_were_retrieved' => 'Gazettes were successfully retrieved.',
    'model_was_updated' => 'Gazette was successfully updated.',
    'model_was_deleted' => 'Gazette was successfully deleted.',
