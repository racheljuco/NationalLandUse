...
return [
    ...
    'hamlet_id' => 'Hamlet',
    'hamlet_id__placeholder' => 'Select hamlet',
    'crop_id' => 'Crop',
    'crop_id__placeholder' => 'Select crop',
    'area' => 'Area',
    'area__placeholder' => 'Enter area here...',
    'harvest' => 'Harvest',
    'harvest__placeholder' => 'Enter harvest here...',
    'households' => 'Households',
    'households__placeholder' => 'Enter households here...',
    ...
    'index_route_description' => 'Retrieve existing agricultures.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the agriculture property name where the value is the assigned value to the retrieved agriculture.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved agriculture.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of agricultures per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved agriculture.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new agriculture.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing agriculture.',
    ...
    'show_route_description' => 'Retrieve existsing agriculture.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the agriculture to retrieve',
    'destroy_route_description' => 'Delete existsing agriculture.',
    ...
    'the_id_of_model_to_delete' => 'The id of the agriculture to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete agricultures.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the agriculture.',
    ...
    'the_requested_model_does_not_exists' => 'The requested agriculture does not exists.',
    ...
    'create' => 'Create New Agriculture',
    'delete' => 'Delete Agriculture',
    'edit' => 'Edit Agriculture',
    'show' => 'Show Agriculture',
    'show_all' => 'Show All Agriculture',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Agriculture.',
    'none_available' => 'No Agricultures Available.',
    'model_plural' => 'Agricultures',
    'model_was_added' => 'Agriculture was successfully added.',
    'model_was_retrieved' => 'Agriculture was successfully retrieved.',
    'models_were_retrieved' => 'Agricultures were successfully retrieved.',
    'model_was_updated' => 'Agriculture was successfully updated.',
    'model_was_deleted' => 'Agriculture was successfully deleted.',
    ...
    'model_id_camel_case' => 'agricultureId',
