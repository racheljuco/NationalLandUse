...
return [
    ...
    'land_use_plan_status_id' => 'Land Use Plan Status',
    'land_use_plan_status_id__placeholder' => 'Select land use plan status',
    'name' => 'Name',
    'name__placeholder' => 'Enter name here...',
    'description' => 'Description',
    'created_date' => 'Created Date',
    'created_date__placeholder' => 'Enter created date here...',
    'status' => 'Status',
    ...
    'index_route_description' => 'Retrieve existing land use plans.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the land use plan property name where the value is the assigned value to the retrieved land use plan.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved land use plan.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of land use plans per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved land use plan.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new land use plan.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing land use plan.',
    ...
    'show_route_description' => 'Retrieve existsing land use plan.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the land use plan to retrieve',
    'destroy_route_description' => 'Delete existsing land use plan.',
    ...
    'the_id_of_model_to_delete' => 'The id of the land use plan to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete land use plans.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the land use plan.',
    ...
    'the_requested_model_does_not_exists' => 'The requested land use plan does not exists.',
    ...
    'create' => 'Create New Land Use Plan',
    'delete' => 'Delete Land Use Plan',
    'edit' => 'Edit Land Use Plan',
    'show' => 'Show Land Use Plan',
    'show_all' => 'Show All Land Use Plan',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Land Use Plan.',
    'none_available' => 'No Land Use Plans Available.',
    'model_plural' => 'Land Use Plans',
    'model_was_added' => 'Land Use Plan was successfully added.',
    'model_was_retrieved' => 'Land Use Plan was successfully retrieved.',
    'models_were_retrieved' => 'Land Use Plans were successfully retrieved.',
    'model_was_updated' => 'Land Use Plan was successfully updated.',
    'model_was_deleted' => 'Land Use Plan was successfully deleted.',
    ...
    'model_id_camel_case' => 'land use planId',
