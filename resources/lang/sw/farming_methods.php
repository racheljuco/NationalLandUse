...
return [
    ...
    'index_route_description' => 'Retrieve existing farming methods.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the farming method property name where the value is the assigned value to the retrieved farming method.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved farming method.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of farming methods per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved farming method.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new farming method.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing farming method.',
    ...
    'show_route_description' => 'Retrieve existsing farming method.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the farming method to retrieve',
    'destroy_route_description' => 'Delete existsing farming method.',
    ...
    'the_id_of_model_to_delete' => 'The id of the farming method to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete farming methods.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the farming method.',
    ...
    'the_requested_model_does_not_exists' => 'The requested farming method does not exists.',
    ...
    'create' => 'Create New Farming Method',
    'delete' => 'Delete Farming Method',
    'edit' => 'Edit Farming Method',
    'show' => 'Show Farming Method',
    'show_all' => 'Show All Farming Method',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Farming Method.',
    'none_available' => 'No Farming Methods Available.',
    'model_plural' => 'Farming Methods',
    'model_was_added' => 'Farming Method was successfully added.',
    'model_was_retrieved' => 'Farming Method was successfully retrieved.',
    'models_were_retrieved' => 'Farming Methods were successfully retrieved.',
    'model_was_updated' => 'Farming Method was successfully updated.',
    'model_was_deleted' => 'Farming Method was successfully deleted.',
    ...
    'model_id_camel_case' => 'farming methodId',
