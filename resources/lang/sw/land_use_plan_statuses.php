...
return [
    ...
    'index_route_description' => 'Retrieve existing land use plan statuses.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the land use plan status property name where the value is the assigned value to the retrieved land use plan status.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved land use plan status.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of land use plan statuses per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved land use plan status.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new land use plan status.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing land use plan status.',
    ...
    'show_route_description' => 'Retrieve existsing land use plan status.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the land use plan status to retrieve',
    'destroy_route_description' => 'Delete existsing land use plan status.',
    ...
    'the_id_of_model_to_delete' => 'The id of the land use plan status to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete land use plan statuses.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the land use plan status.',
    ...
    'the_requested_model_does_not_exists' => 'The requested land use plan status does not exists.',
    ...
    'create' => 'Create New Land Use Plan Status',
    'delete' => 'Delete Land Use Plan Status',
    'edit' => 'Edit Land Use Plan Status',
    'show' => 'Show Land Use Plan Status',
    'show_all' => 'Show All Land Use Plan Status',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Land Use Plan Status.',
    'none_available' => 'No Land Use Plan Statuses Available.',
    'model_plural' => 'Land Use Plan Statuses',
    'model_was_added' => 'Land Use Plan Status was successfully added.',
    'model_was_retrieved' => 'Land Use Plan Status was successfully retrieved.',
    'models_were_retrieved' => 'Land Use Plan Statuses were successfully retrieved.',
    'model_was_updated' => 'Land Use Plan Status was successfully updated.',
    'model_was_deleted' => 'Land Use Plan Status was successfully deleted.',
    ...
    'model_id_camel_case' => 'land use plan statusId',
