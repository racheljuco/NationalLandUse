...
return [
    ...
    'type_mineral_id' => 'Type mineral',
    'typemineral_id__placeholder' => 'Select type mineral',
    'name' => 'Name',
    ...
    'index_route_description' => 'Retrieve existing minerals.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the mineral property name where the value is the assigned value to the retrieved mineral.',
    ...
    'show_route_description' => 'Retrieve existsing mineral.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the mineral to retrieve',
    'destroy_route_description' => 'Delete existsing mineral.',
    ...
    'the_id_of_model_to_delete' => 'The id of the mineral to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete minerals.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the mineral.',
    ...
    'the_requested_model_does_not_exists' => 'The requested mineral does not exists.',
    ...
    'create' => 'Create New mineral',
    'delete' => 'Delete mineral',
    'edit' => 'Edit mineral',
    'show' => 'Show mineral',
    'show_all' => 'Show All mineral',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete mineral.',
    'none_available' => 'No minerals Available.',
    'model_plural' => 'minerals',
    'model_was_added' => 'mineral was successfully added.',
    'model_was_retrieved' => 'mineral was successfully retrieved.',
    'models_were_retrieved' => 'minerals were successfully retrieved.',
    'model_was_updated' => 'mineral was successfully updated.',
    'model_was_deleted' => 'mineral was successfully deleted.',
