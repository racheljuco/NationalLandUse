...
return [
    ...
    'index_route_description' => 'Retrieve existing farm inputs.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the farm input property name where the value is the assigned value to the retrieved farm input.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved farm input.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of farm inputs per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved farm input.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new farm input.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing farm input.',
    ...
    'show_route_description' => 'Retrieve existsing farm input.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the farm input to retrieve',
    'destroy_route_description' => 'Delete existsing farm input.',
    ...
    'the_id_of_model_to_delete' => 'The id of the farm input to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete farm inputs.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the farm input.',
    ...
    'the_requested_model_does_not_exists' => 'The requested farm input does not exists.',
    ...
    'create' => 'Create New Farm Input',
    'delete' => 'Delete Farm Input',
    'edit' => 'Edit Farm Input',
    'show' => 'Show Farm Input',
    'show_all' => 'Show All Farm Input',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Farm Input.',
    'none_available' => 'No Farm Inputs Available.',
    'model_plural' => 'Farm Inputs',
    'model_was_added' => 'Farm Input was successfully added.',
    'model_was_retrieved' => 'Farm Input was successfully retrieved.',
    'models_were_retrieved' => 'Farm Inputs were successfully retrieved.',
    'model_was_updated' => 'Farm Input was successfully updated.',
    'model_was_deleted' => 'Farm Input was successfully deleted.',
    ...
    'model_id_camel_case' => 'farm inputId',
