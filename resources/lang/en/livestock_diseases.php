...
return [
    ...
    'livestock_disease_name' => 'Livestock disease Name',
    'livestock_disease_name__placeholder' => 'Enter livestock disease name here...',
    ...
    'index_route_description' => 'Retrieve existing Livestocks.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the Livestock property name where the value is the assigned value to the retrieved Livestock.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved Livestock.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of Livestocks per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved Livestock.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new Livestock.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing Livestock.',
    ...
    'show_route_description' => 'Retrieve existsing Livestock.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the Livestock to retrieve',
    'destroy_route_description' => 'Delete existsing Livestock.',
    ...
    'the_id_of_model_to_delete' => 'The id of the Livestock to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete Livestocks.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the Livestock.',
    ...
    'the_requested_model_does_not_exists' => 'The requested Livestock does not exists.',
    ...
    'create' => 'Create New Livestock',
    'delete' => 'Delete Livestock',
    'edit' => 'Edit Livestock',
    'show' => 'Show Livestock',
    'show_all' => 'Show All Livestock',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Livestock.',
    'none_available' => 'No Livestocks Available.',
    'model_plural' => 'Livestocks',
    'model_was_added' => 'Livestock was successfully added.',
    'model_was_retrieved' => 'Livestock was successfully retrieved.',
    'models_were_retrieved' => 'Livestocks were successfully retrieved.',
    'model_was_updated' => 'Livestock was successfully updated.',
    'model_was_deleted' => 'Livestock was successfully deleted.',
    ...
    'model_id_camel_case' => 'LivestockId',
