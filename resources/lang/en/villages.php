...
return [
    ...
    'village_name__placeholder' => 'Enter village name here...',
    ...
    'index_route_description' => 'Retrieve existing villages.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the village property name where the value is the assigned value to the retrieved village.',
    ...
    'show_route_description' => 'Retrieve existsing village.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the village to retrieve',
    'destroy_route_description' => 'Delete existsing village.',
    ...
    'the_id_of_model_to_delete' => 'The id of the village to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete villages.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the village.',
    ...
    'the_requested_model_does_not_exists' => 'The requested village does not exists.',
    ...
    'create' => 'Create New Village',
    'delete' => 'Delete Village',
    'edit' => 'Edit Village',
    'show' => 'Show Village',
    'show_all' => 'Show All Village',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Village.',
    'none_available' => 'No Villages Available.',
    'model_plural' => 'Villages',
    'model_was_added' => 'Village was successfully added.',
    'model_was_retrieved' => 'Village was successfully retrieved.',
    'models_were_retrieved' => 'Villages were successfully retrieved.',
    'model_was_updated' => 'Village was successfully updated.',
    'model_was_deleted' => 'Village was successfully deleted.',
