...
return [
    ...
    'filepath' => 'Filepath',
    'filepath__placeholder' => 'Enter filepath here...',
    ...
    'index_route_description' => 'Retrieve existing shape files.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the shape file property name where the value is the assigned value to the retrieved shape file.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved shape file.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of shape files per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved shape file.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new shape file.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing shape file.',
    ...
    'show_route_description' => 'Retrieve existsing shape file.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the shape file to retrieve',
    'destroy_route_description' => 'Delete existsing shape file.',
    ...
    'the_id_of_model_to_delete' => 'The id of the shape file to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete shape files.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the shape file.',
    ...
    'the_requested_model_does_not_exists' => 'The requested shape file does not exists.',
    ...
    'create' => 'Create New Shape File',
    'delete' => 'Delete Shape File',
    'edit' => 'Edit Shape File',
    'show' => 'Show Shape File',
    'show_all' => 'Show All Shape File',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Shape File.',
    'none_available' => 'No Shape Files Available.',
    'model_plural' => 'Shape Files',
    'model_was_added' => 'Shape File was successfully added.',
    'model_was_retrieved' => 'Shape File was successfully retrieved.',
    'models_were_retrieved' => 'Shape Files were successfully retrieved.',
    'model_was_updated' => 'Shape File was successfully updated.',
    'model_was_deleted' => 'Shape File was successfully deleted.',
    ...
    'model_id_camel_case' => 'shape fileId',
