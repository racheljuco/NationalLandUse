...
return [
    ...
    'number_of_livestock__placeholder' => 'Enter livestock quantity here...',
    ...
    'index_route_description' => 'Retrieve existing livestock types.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the livestock type property name where the value is the assigned value to the retrieved livestock type.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved livestock type.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of livestock types per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved livestock type.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new livestock type.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing livestock type.',
    ...
    'show_route_description' => 'Retrieve existsing livestock type.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the livestock type to retrieve',
    'destroy_route_description' => 'Delete existsing livestock type.',
    ...
    'the_id_of_model_to_delete' => 'The id of the livestock type to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete livestock types.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the livestock type.',
    ...
    'the_requested_model_does_not_exists' => 'The requested livestock type does not exists.',
    ...
    'create' => 'Create New livestock Type',
    'delete' => 'Delete livestock Type',
    'edit' => 'Edit livestock Type',
    'show' => 'Show livestock Type',
    'show_all' => 'Show All livestock Type',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete livestock Type.',
    'none_available' => 'No livestock Types Available.',
    'model_plural' => 'livestock Types',
    'model_was_added' => 'livestock Type was successfully added.',
    'model_was_retrieved' => 'livestock Type was successfully retrieved.',
    'models_were_retrieved' => 'livestock Types were successfully retrieved.',
    'model_was_updated' => 'livestock Type was successfully updated.',
    'model_was_deleted' => 'livestock Type was successfully deleted.',
    ...
    'model_id_camel_case' => 'livestock typeId',
