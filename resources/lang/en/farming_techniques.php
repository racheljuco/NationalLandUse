...
return [
    ...
    'index_route_description' => 'Retrieve existing farming techniques.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the farming technique property name where the value is the assigned value to the retrieved farming technique.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved farming technique.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of farming techniques per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved farming technique.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new farming technique.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing farming technique.',
    ...
    'show_route_description' => 'Retrieve existsing farming technique.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the farming technique to retrieve',
    'destroy_route_description' => 'Delete existsing farming technique.',
    ...
    'the_id_of_model_to_delete' => 'The id of the farming technique to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete farming techniques.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the farming technique.',
    ...
    'the_requested_model_does_not_exists' => 'The requested farming technique does not exists.',
    ...
    'create' => 'Create New Farming Technique',
    'delete' => 'Delete Farming Technique',
    'edit' => 'Edit Farming Technique',
    'show' => 'Show Farming Technique',
    'show_all' => 'Show All Farming Technique',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Farming Technique.',
    'none_available' => 'No Farming Techniques Available.',
    'model_plural' => 'Farming Techniques',
    'model_was_added' => 'Farming Technique was successfully added.',
    'model_was_retrieved' => 'Farming Technique was successfully retrieved.',
    'models_were_retrieved' => 'Farming Techniques were successfully retrieved.',
    'model_was_updated' => 'Farming Technique was successfully updated.',
    'model_was_deleted' => 'Farming Technique was successfully deleted.',
    ...
    'model_id_camel_case' => 'farming techniqueId',
