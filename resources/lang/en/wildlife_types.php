...
return [
    ...
    'number_of_wildlife__placeholder' => 'Enter wildlife quantity here...',
    ...
    'index_route_description' => 'Retrieve existing wildlife types.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the wildlife type property name where the value is the assigned value to the retrieved wildlife type.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved wildlife type.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of wildlife types per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved wildlife type.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new wildlife type.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing wildlife type.',
    ...
    'show_route_description' => 'Retrieve existsing wildlife type.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the wildlife type to retrieve',
    'destroy_route_description' => 'Delete existsing wildlife type.',
    ...
    'the_id_of_model_to_delete' => 'The id of the wildlife type to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete wildlife types.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the wildlife type.',
    ...
    'the_requested_model_does_not_exists' => 'The requested wildlife type does not exists.',
    ...
    'create' => 'Create New wildlife Type',
    'delete' => 'Delete wildlife Type',
    'edit' => 'Edit wildlife Type',
    'show' => 'Show wildlife Type',
    'show_all' => 'Show All wildlife Type',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete wildlife Type.',
    'none_available' => 'No wildlife Types Available.',
    'model_plural' => 'wildlife Types',
    'model_was_added' => 'wildlife Type was successfully added.',
    'model_was_retrieved' => 'wildlife Type was successfully retrieved.',
    'models_were_retrieved' => 'wildlife Types were successfully retrieved.',
    'model_was_updated' => 'wildlife Type was successfully updated.',
    'model_was_deleted' => 'wildlife Type was successfully deleted.',
    ...
    'model_id_camel_case' => 'wildlife typeId',
