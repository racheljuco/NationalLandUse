...
return [
    ...
    'index_route_description' => 'Retrieve existing farming systems.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the farming system property name where the value is the assigned value to the retrieved farming system.',
    ...
    'the_index_of_the_first_retrieved_item' => 'The index of first retrieved farming system.',
    'the_number_of_the_last_page' => 'The number of the last page.',
    'the_base_link_to_the_resource' => 'The base link to the api resource.',
    'the_number_of_models_per_page' => 'The number of farming systems per page.',
    'the_index_of_the_last_retrieved_item' => 'The index of last retrieved farming system.',
    'the_total_of_available_pages' => 'The total of the available pages.',
    'store_route_description' => 'Create new farming system.',
    'store_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'update_route_description' => 'Update existsing farming system.',
    ...
    'show_route_description' => 'Retrieve existsing farming system.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the farming system to retrieve',
    'destroy_route_description' => 'Delete existsing farming system.',
    ...
    'the_id_of_model_to_delete' => 'The id of the farming system to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete farming systems.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the farming system.',
    ...
    'the_requested_model_does_not_exists' => 'The requested farming system does not exists.',
    ...
    'create' => 'Create New Farming System',
    'delete' => 'Delete Farming System',
    'edit' => 'Edit Farming System',
    'show' => 'Show Farming System',
    'show_all' => 'Show All Farming System',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Farming System.',
    'none_available' => 'No Farming Systems Available.',
    'model_plural' => 'Farming Systems',
    'model_was_added' => 'Farming System was successfully added.',
    'model_was_retrieved' => 'Farming System was successfully retrieved.',
    'models_were_retrieved' => 'Farming Systems were successfully retrieved.',
    'model_was_updated' => 'Farming System was successfully updated.',
    'model_was_deleted' => 'Farming System was successfully deleted.',
    ...
    'model_id_camel_case' => 'farming systemId',
